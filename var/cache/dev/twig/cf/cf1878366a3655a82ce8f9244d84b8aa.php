...
/* tag/new.html.twig */
class __TwigTemplate_dfb95293cdcb8e21563ca4e318d573bf extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  129 => 32,  124 => 30,  108 => 17,  102 => 16,  90 => 6,  80 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}{{ site_name }}: {% trans %}New Tag{% endtrans %}{% endblock %}
...
<main id=\"main\">
        ...
        <div class=\"container\">
            ...
            <div class=\"d-flex justify-content-between align-items-center\">
                ...
                <ol>
                    ...
                    <li>{% trans %}Admin Index{% endtrans %}</li>
                </ol>
            </div>
    ...
    <section id=\"blog\" class=\"blog\">
        <div class=\"container\" data-aos=\"fade-up\">
            ...
            <div class=\"row d-flex justify-content-center mb-5\">
                <div class=\"col\">
                    <h1>{% trans %}Create new Tag{% endtrans %}</h1>
...
{% endblock %}", "tag/new.html.twig", "C:\\Users\\Malik\\Desktop\\blog-main\\templates\\tag\\new.html.twig");
    }
}
