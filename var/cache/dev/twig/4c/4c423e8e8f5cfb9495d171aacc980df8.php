...
class __TwigTemplate_a2334decac07c6a281a5b28a244a8c19 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo ": ";
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Edit Comment", [], "messages");
...
";
    ...
    {
        return array (  142 => 34,  137 => 32,  121 => 19,  115 => 18,  111 => 17,  105 => 16,  99 => 13,  90 => 6,  80 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}{{ site_name }}: {% trans %}Edit Comment{% endtrans %}{% endblock %}
...
<main id=\"main\">
        ...
        <div class=\"container\">
            ...
            <div class=\"d-flex justify-content-between align-items-center\">
                ...
                <ol>
                    ...
                    <li><a href=\"{{ path('comment_admin_index') }}\">{% trans %}Comment{% endtrans %}</a></li>
    ...
    <section id=\"blog\" class=\"blog\">
        <div class=\"container\" data-aos=\"fade-up\">
            ...
            <div class=\"row d-flex justify-content-center mb-5\">
                <div class=\"col\">
                    <h1>{% trans %}Edit Comment{% endtrans %}</h1>
...
{% endblock %}", "comment/edit.html.twig", "C:\\Users\\Malik\\Desktop\\blog-main\\templates\\comment\\edit.html.twig");
    }
}
