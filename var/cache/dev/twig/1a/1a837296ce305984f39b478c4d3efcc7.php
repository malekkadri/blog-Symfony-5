...
class __TwigTemplate_b585c0fb39ae6418c4f5c4598ad67844 extends Template
{
    private $source;
    private $macros = [];
    ...
    <section id=\"blog\" class=\"blog\">
        ...
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("ERROR", [], "messages");
        echo " ";
        echo twig_escape_filter($this->env, (isset($context["status_code"]) || array_key_exists("status_code", $context) ? $context["status_code"] : (function () { throw new RuntimeError('Variable "status_code" does not exist.', 29, $this->source); })()), "html", null, true);
        echo "</h1>
                    <h1 class=\"display-4 mb-5\">";
        // line 30
        echo twig_escape_filter($this->env, (isset($context["status_text"]) || array_key_exists("status_text", $context) ? $context["status_text"] : (function () { throw new RuntimeError('Variable "status_text" does not exist.', 30, $this->source); })()), "html", null, true);
        echo "</h1>
                    ";
        // line 31
...
";
    ...
    {
        return array (  144 => 34,  140 => 32,  138 => 31,  134 => 30,  128 => 29,  111 => 17,  107 => 16,  101 => 13,  92 => 6,  82 => 5,  59 => 3,  36 => 1,);
    }
...
<main id=\"main\">
    ...
    <section id=\"blog\" class=\"blog\">
        <div class=\"container\" data-aos=\"fade-up\">
            <div class=\"row\">
                <div class=\"col mt-4 alert-danger py-5 px-3\">
                    <h1 class=\"display-1 font-weight-bold\">{% trans %}ERROR{% endtrans %} {{ status_code }}</h1>
                    <h1 class=\"display-4 mb-5\">{{ status_text }}</h1>
                    {% trans %}Click the button below{% endtrans %}
                </div>
                <div class=\"mt-3\">
                    <a class=\"btn btn-primary p-3 lead\" href=\"{{ path('home') }}\">{% trans %}Back to Home page{% endtrans %}</a>
                </div>
            </div>
        </div>
    </section>
</main>
{% endblock %}", "@Twig/Exception/error.html.twig", "C:\\Users\\Malik\\Desktop\\blog-main\\templates\\bundles\\TwigBundle\\Exception\\error.html.twig");
    }
}
