...
class __TwigTemplate_14d341a5a00fa64991f54f03c0fbe6ce extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  137 => 34,  132 => 32,  115 => 18,  111 => 17,  105 => 16,  99 => 13,  90 => 6,  80 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}{{ site_name }}: {% trans %}new category{% endtrans %}{% endblock %}
        ...
        <div class=\"container\">
            ...
            <div class=\"d-flex justify-content-between align-items-center\">
                ...
                <ol>
                    ...
                    <li>{% trans %}New category{% endtrans %}</li>
                </ol>
            </div>
    ...
    <section id=\"blog\" class=\"blog\">
        <div class=\"container\" data-aos=\"fade-up\">
            ...
            <div class=\"row py-5\">
                ...
                <div class=\"col mb-4\">
                    <h1>{% trans %}Create new Category{% endtrans %}</h1>
...
{% endblock %}", "category/new.html.twig", "C:\\Users\\Malik\\Desktop\\blog-main\\templates\\category\\new.html.twig");
    }
}
