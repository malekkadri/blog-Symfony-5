...
/* tag/edit.html.twig */
class __TwigTemplate_f3b61ec7e7dfbdcd9846418b485edef1 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo ": ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["tag"]) || array_key_exists("tag", $context) ? $context["tag"] : (function () { throw new RuntimeError('Variable "tag" does not exist.', 3, $this->source); })()), "title", [], "any", false, false, false, 3), "html", null, true);
    ...
    <section class=\"breadcrumbs\">
        ...
        echo "\">Tag</a></li>
                    <li>";
        // line 19
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["tag"]) || array_key_exists("tag", $context) ? $context["tag"] : (function () { throw new RuntimeError('Variable "tag" does not exist.', 19, $this->source); })()), "title", [], "any", false, false, false, 19), "html", null, true);
        echo "</li>
                </ol>
            </div>
...
";
    ...
    {
        return array (  137 => 34,  132 => 32,  116 => 19,  112 => 18,  108 => 17,  102 => 16,  90 => 6,  80 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}{{ site_name }}: {{ tag.title }}{% endblock %}
        ...
        <div class=\"container\">
            ...
            <div class=\"d-flex justify-content-between align-items-center\">
                ...
                <ol>
                    ...
                    <li><a href=\"{{ path('tag_admin_index') }}\">Tag</a></li>
                    <li>{{ tag.title }}</li>
                </ol>
            </div>
...
{% endblock %}", "tag/edit.html.twig", "C:\\Users\\Malik\\Desktop\\blog-main\\templates\\tag\\edit.html.twig");
    }
}
