...
class __TwigTemplate_b12b2062662743127e71c01dfbb20466 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  127 => 30,  111 => 17,  105 => 16,  100 => 14,  90 => 6,  80 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}{{ site_name }}: {% trans %}About us{% endtrans %}{% endblock %}
...
<main id=\"main\">
    ...
    <section class=\"breadcrumbs\">
        <div class=\"container\">
            ...
            <div class=\"d-flex justify-content-between align-items-center\">
                <h2>{% trans %}About Us{% endtrans %}</h2>
                <ol>
                    <li><a href=\"{{ path('home') }}\">{% trans %}Home{% endtrans %}</a></li>
                    <li>{% trans %}About Us{% endtrans %}</li>
                </ol>
            </div>
    ...
    <section class=\"about\" data-aos=\"fade-up\">
        <div class=\"container\">
            ...
            <div class=\"row\">
                <div class=\"col-lg-6\">
                    <img src=\"{{ asset('img/about.jpg') }}\" class=\"img-fluid\" alt=\"about\">
                </div>
                <div class=\"col-lg-6 pt-4 pt-lg-0\">
                    <h3>Voluptatem dignissimos provident quasi corporis voluptates sit assumenda.</h3>
                    <p class=\"fst-italic\">
...
{% endblock %}", "home/about.html.twig", "C:\\Users\\Malik\\Desktop\\blog-main\\templates\\home\\about.html.twig");
    }
}
