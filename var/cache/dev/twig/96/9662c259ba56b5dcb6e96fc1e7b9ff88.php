...
class __TwigTemplate_48efca3af74645183bdd02f56ce5aad4 extends Template
{
    private $source;
    private $macros = [];
    ...
    <section id=\"blog\" class=\"blog\">
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 35, $this->source); })()), "articles", [], "any", false, false, false, 35));
...
";
    ...
    {
        return array (  163 => 42,  151 => 38,  147 => 36,  143 => 35,  139 => 34,  134 => 32,  117 => 18,  111 => 17,  105 => 16,  99 => 13,  90 => 6,  80 => 5,  59 => 3,  36 => 1,);
    }
        ...
        <div class=\"container\">
            ...
            <div class=\"d-flex justify-content-between align-items-center\">
                ...
                <ol>
                    ...
                    <li><a href=\"{{ path('category_index') }}\">{% trans %}Category{% endtrans %}</a></li>
        ...
        <div class=\"container\" data-aos=\"fade-up\">
            ...
            <div class=\"row py-5\">
                ...
                <div class=\"col mb-4\">
                    ...
                    <p>{% trans %}Category's articles{% endtrans %}</p>
                    {% for c in category.articles %}
                        <div class=\"row py-1\">
                            <div class=\"col\">
                                <i class=\"bi bi-arrow-down-right-square-fill\"></i> <a href=\"{{ path('article_show', { 'slug': c.slug }) }}\">{{ c.title }}</a>
                            </div>
                        </div>
                    {% endfor %}
...
{% endblock %}", "category/show.html.twig", "C:\\Users\\Malik\\Desktop\\blog-main\\templates\\category\\show.html.twig");
    }
}
