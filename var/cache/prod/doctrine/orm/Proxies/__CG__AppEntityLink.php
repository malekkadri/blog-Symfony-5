...
class Link extends \App\Entity\Link implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Link' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Link' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Link' . "\0" . 'url', '' . "\0" . 'App\\Entity\\Link' . "\0" . 'presentation'];
        }
     ...
     * {@inheritDoc}
     */
    public function setUrl(string $url): \App\Entity\Link
    {
     ...
     * {@inheritDoc}
     */
    public function setPresentation(string $presentation): \App\Entity\Link
    {
