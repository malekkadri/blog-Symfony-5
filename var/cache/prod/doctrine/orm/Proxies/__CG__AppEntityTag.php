...
class Tag extends \App\Entity\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Tag' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Tag' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Tag' . "\0" . 'slug', '' . "\0" . 'App\\Entity\\Tag' . "\0" . 'article'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTitle(string $title): \App\Entity\Tag
    {
